        ...
        {activeTab === 'disclaimer' && (
          <div className="legal-section">
            ...
            <div className="warning-box">
              <h3>⚠️ AI-Generated Content Notice</h3>
              <p>
                <strong>This website was created using artificial intelligence (AI) technology.</strong>
                The analysis, visualisations, and written content have been generated by AI systems
                trained on publicly available data about Burnley Borough Council.
              </p>
            </div>
            ...
            <p>
              ...
              website may contain errors, omissions, or inaccuracies. The AI systems used to process
              and analyse data can make mistakes. Specific limitations include:
            </p>
            <ul>
              <li>Data may be out of date or superseded by more recent information</li>
              <li>AI interpretation of PDF documents may contain extraction errors</li>
              <li>Categorisation and analysis may not reflect official council classifications</li>
              <li>Financial figures should be verified against official council publications</li>
            ...
            <ul>
              ...
              <li>Reputational harm arising from AI-generated content</li>
            </ul>
