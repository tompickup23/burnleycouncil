...
export default function Roadworks() {
  ...
  // Load data (no highways_assets.json or procurement_pipeline.json needed)
    ...
    return (
      <div className="highways-page">
        <div className="hw-empty">
          ...
          <h2>Roadworks data not available</h2>
          <p>Roadworks monitoring is not enabled for {config.council_name || 'this council'}.</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="highways-page">
        <div className="hw-empty">
          ...
          <h2>Failed to load roadworks data</h2>
    ...
    <div className="highways-page">
      ...
      <div className="hw-hero">
        ...
        <p className="hw-subtitle">
          Real-time roadworks data across {meta.scope || 'Lancashire'} — {formatNumber(roadworks.length)} active and planned works
        </p>
      ...
      <div className="hw-list-section">
        ...
        {/* Link to full Highways analysis */}
        <div style={{ textAlign: 'center', margin: '32px 0 16px' }}>
          ...
          >
            View Highways Department Analysis →
          </Link>
        </div>
      </div>
    </div>
