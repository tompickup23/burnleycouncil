...
export const REFORM_REBUTTALS = [
  { attack: 'You\'re cutting services', rebuttal: 'We inherited a £28M overspend and have delivered near-zero while protecting frontline services. 5 care homes saved, 677 SEND places created, £23M adult social care savings found without cutting services.', policyAreas: ['budget_finance', 'social_care'] },
  ...
  { attack: 'Not enough consultation', rebuttal: '1,600+ residents consulted on care homes alone — more meaningful consultation than the Conservatives delivered in 8 years of control.', policyAreas: ['social_care', 'governance_constitution'] },
  ...
  { attack: 'Pension fund concerns', rebuttal: 'We exposed the £350M VeLTIP bond loss the Conservatives concealed. We stopped excessive company directors\' fees. The national DOGE team is providing support on pension fund fee analysis.', policyAreas: ['budget_finance', 'governance_constitution'] },
]
