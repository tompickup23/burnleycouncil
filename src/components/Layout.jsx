...
const navSections = [
  {
    items: [
      ...
      { path: '/chat', icon: Sparkles, label: 'Ask Lancashire' },
    ],
  },
  {
    title: 'Transparency',
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/economy', icon: Briefcase, label: 'Economy & Work', requires: 'economy' },
  ...
  },
  {
    ...
    collapsible: true,
    items: [
      { path: '/highways', icon: Construction, label: 'Highways', requires: 'highways' },
    ],
  },
  {
    title: 'Analysis',
