    ...
    >
      <defs>
        ...
        <linearGradient id={`${id}-shield`} x1="20" y1="10" x2="100" y2="110" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="#12B6CF" />
          <stop offset="50%" stopColor="#5e5ce6" />
          <stop offset="100%" stopColor="#12B6CF" />
        </linearGradient>
        {/* Inner glow */}
        ...
        <radialGradient id={`${id}-lens`} cx="55" cy="50" r="22" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor="rgba(18, 182, 207, 0.15)" />
          <stop offset="100%" stopColor="rgba(18, 182, 207, 0.03)" />
        </radialGradient>
        {/* Outer glow */}
        <filter id={`${id}-glow`}>
      ...
      <circle cx="55" cy="52" r="20" fill={`url(#${id}-lens)`} stroke="#12B6CF" strokeWidth="2" opacity="0.9" />

      {/* Eye/scan lines inside lens */}
      <line x1="42" y1="46" x2="68" y2="46" stroke="#12B6CF" strokeWidth="1.5" opacity="0.4" strokeLinecap="round" />
      <line x1="42" y1="52" x2="68" y2="52" stroke="#12B6CF" strokeWidth="2" opacity="0.6" strokeLinecap="round" />
      <line x1="42" y1="58" x2="68" y2="58" stroke="#12B6CF" strokeWidth="1.5" opacity="0.4" strokeLinecap="round" />

      {/* Magnifying glass handle */}
      <line x1="69" y1="66" x2="83" y2="80" stroke="#5e5ce6" strokeWidth="4" strokeLinecap="round" />
      <line x1="69" y1="66" x2="83" y2="80" stroke="#12B6CF" strokeWidth="2.5" strokeLinecap="round" />
      ...
      <circle cx="36" cy="34" r="2.5" fill="#12B6CF" opacity="0.5" />
      <circle cx="74" cy="34" r="2.5" fill="#5e5ce6" opacity="0.5" />
      <circle cx="60" cy="86" r="2.5" fill="#30d158" opacity="0.5" />
      <line x1="36" y1="34" x2="55" y2="47" stroke="#12B6CF" strokeWidth="0.8" opacity="0.2" />
