...
| `src/utils/savingsEngine.js` | Cabinet Command engine: centralised savings model, portfolio-spending mapping, prescriptive directives (DO/SAVE/LEGAL/ROUTE), decision pathways, reform playbooks, MTFS comparison, political impact, benchmarking (24 functions, 69 tests) |
...
| `src/**/*.test.{js,jsx}` | Unit tests: 2,526 tests across 53 files (vitest) |
